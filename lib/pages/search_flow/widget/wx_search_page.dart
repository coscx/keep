...
import 'package:keep/common/entities/home/only_store.dart';
import 'package:keep/pages/search_flow/widget/single_choice.dart';
              ...
              Container(
                ...
                child:SfRangeSlider(
                  ...
                  onChanged: (SfRangeValues values){
                    setState(() {
                     // _values = values;
                      minValue = values.start.round();
                      maxValue = values.end.round();
                      int j = 0, k = 0;
