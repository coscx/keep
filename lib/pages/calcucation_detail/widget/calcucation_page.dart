...
import 'package:keep/common/entities/loan/loan.dart';
...
class CalcucationPages extends StatefulWidget {
  const CalcucationPages({Key? key}) : super(key: key);

  @override
  _FinPageState createState() => _FinPageState();
}

class _FinPageState extends State<CalcucationPages> {
  ...
  String myName = "";
  bool myValue = false;
  List<QuotaListDataData> loanData = <QuotaListDataData>[];
  int page =1;
  @override
  void initState() {
    _df();
  ...
  _df() async {
    var d = await CommonAPI.GetCalcucationList(page,182);
