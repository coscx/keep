   ...
   return Column(
     children: [
       Container(
         ...
         child: Image.asset("assets/images/keep/no_result.png"),
       ),
       Container(
         padding: EdgeInsets.only(
    ...
    children: [
      ...
      Container(
        ...
        child: Row(
          ...
          children: [
            _buildMiddle("assets/images/keep/edu.png","额度高","最高额度100万"),
            _buildMiddle("assets/images/keep/qianxian.png","期限长","最长期限8年"),
            _buildMiddle("assets/images/keep/fangkuan.png","放款快","最快一天放款"),
          ],
        ),
      ),
